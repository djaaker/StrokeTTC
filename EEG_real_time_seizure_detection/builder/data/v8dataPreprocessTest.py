...
def preprocess():
    ...
    mlData = pd.DataFrame({'file': edfFiles})
...
def get_data_preprocessed(args):
    ...
    test_dataset = Detector_Dataset(args.EDFFile, 1, args)

    # Create data loaders
    test_loader = DataLoader(test_dataset, batch_size=1, shuffle=False,
                             drop_last=False, num_workers=1, pin_memory=True)

    print("Number of test data:", 1)

    return test_loader, test_loader, test_loader, 0, 0, 1
